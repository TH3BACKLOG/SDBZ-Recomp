...
// Builds a fixture ELF whose .ctors/.init_array-style initializer table points at
// `initializerTarget`, used to exercise the correctness-critical-initializer path
// (a global constructor must never be silently skipped/stubbed by the recompiler).
...
// Builds a fixture ELF with a single giant "giant_func" function, all NOPs, ending in
// jr $ra + delay-slot nop. Used to exercise the opt-in per-function O1 heuristic for
// giant recompiled functions.
